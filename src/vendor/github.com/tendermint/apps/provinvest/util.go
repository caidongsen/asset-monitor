...
func (app *ProvinvestApplication) saveReceipt(instructionId int64, receipt *Receipt) error {
...
func (app *ProvinvestApplication) checkInstructionId(instructionId int64) error {
...
/*func (app *ProvinvestApplication) loadAdmins() *Admins {
...
func (app *ProvinvestApplication) getAdminType(str []byte) AdminType {
