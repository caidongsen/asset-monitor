...
type PersistentSupplychainApplication struct {
	app *SupplychainApplication
	db  dbm.DB
...
func NewPersistentSupplychainApplication(dbDir string) *PersistentSupplychainApplication {
	db := dbm.NewDB("supplychain", "leveldb", dbDir)
	...
	return &PersistentSupplychainApplication{
		app:    &SupplychainApplication{state: stateTree},
		db:     db,
		logger: log.NewNopLogger(),
	}
}

func (app *PersistentSupplychainApplication) SetLogger(l log.Logger) {
	app.logger = l
}

func (app *PersistentSupplychainApplication) Info() (resInfo types.ResponseInfo) {
...
func (app *PersistentSupplychainApplication) SetOption(key string, value string) (log string) {
	return app.app.SetOption(key, value)
}

// tx is either "key=value" or just arbitrary bytes
func (app *PersistentSupplychainApplication) DeliverTx(tx []byte) types.Result {
...
func (app *PersistentSupplychainApplication) CheckTx(tx []byte) types.Result {
	return app.app.CheckTx(tx)
}

func (app *PersistentSupplychainApplication) Commit() types.Result {
	// Save
...
func (app *PersistentSupplychainApplication) Query(reqQuery types.RequestQuery) types.ResponseQuery {
	return app.app.Query(reqQuery)
}

// Save the validators in the merkle tree
func (app *PersistentSupplychainApplication) InitChain(validators []*types.Validator) {
...
func (app *PersistentSupplychainApplication) BeginBlock(hash []byte, header *types.Header) {
...
func (app *PersistentSupplychainApplication) EndBlock(height uint64) (resEndBlock types.ResponseEndBlock) {
...
func (app *PersistentSupplychainApplication) Validators() (validators []*types.Validator) {
...
func (app *PersistentSupplychainApplication) execValidatorTx(tx []byte) types.Result {
...
func (app *PersistentSupplychainApplication) updateValidator(v *types.Validator) types.Result {
