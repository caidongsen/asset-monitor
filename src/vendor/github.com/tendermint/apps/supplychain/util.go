...
func (app *SupplychainApplication) saveReceipt(instructionId int64, receipt *Receipt) error {
...
func (app *SupplychainApplication) checkInstructionId(instructionId int64) error {
...
func (app *SupplychainApplication) loadAdmins() *Admins {
...
func (app *SupplychainApplication) getAdminType(str []byte) AdminType {
