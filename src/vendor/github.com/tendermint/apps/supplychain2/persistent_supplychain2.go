...
type PersistentSupplychain2Application struct {
	app *Supplychain2Application
	db  dbm.DB
...
func NewPersistentSupplychain2Application(dbDir string) *PersistentSupplychain2Application {
	db := dbm.NewDB("supplychain2", "leveldb", dbDir)
	...
	return &PersistentSupplychain2Application{
		app:    &Supplychain2Application{state: stateTree},
		db:     db,
		logger: log.NewNopLogger(),
	}
}

func (app *PersistentSupplychain2Application) SetLogger(l log.Logger) {
	app.logger = l
}

func (app *PersistentSupplychain2Application) Info() (resInfo types.ResponseInfo) {
...
func (app *PersistentSupplychain2Application) SetOption(key string, value string) (log string) {
	return app.app.SetOption(key, value)
}

// tx is either "key=value" or just arbitrary bytes
func (app *PersistentSupplychain2Application) DeliverTx(tx []byte) types.Result {
...
func (app *PersistentSupplychain2Application) CheckTx(tx []byte) types.Result {
	return app.app.CheckTx(tx)
}

func (app *PersistentSupplychain2Application) Commit() types.Result {
	// Save
...
func (app *PersistentSupplychain2Application) Query(reqQuery types.RequestQuery) types.ResponseQuery {
	return app.app.Query(reqQuery)
}

// Save the validators in the merkle tree
func (app *PersistentSupplychain2Application) InitChain(validators []*types.Validator) {
...
func (app *PersistentSupplychain2Application) BeginBlock(hash []byte, header *types.Header) {
...
func (app *PersistentSupplychain2Application) EndBlock(height uint64) (resEndBlock types.ResponseEndBlock) {
...
func (app *PersistentSupplychain2Application) Validators() (validators []*types.Validator) {
...
func (app *PersistentSupplychain2Application) execValidatorTx(tx []byte) types.Result {
...
func (app *PersistentSupplychain2Application) updateValidator(v *types.Validator) types.Result {
