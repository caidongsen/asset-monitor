...
func (app *Supplychain2Application) checkOperationRecord(pubkey []byte, version string) error {
...
func (app *Supplychain2Application) operationRecord(pubkey []byte, version string, record string, instructionId int64) (*Response, error) {
