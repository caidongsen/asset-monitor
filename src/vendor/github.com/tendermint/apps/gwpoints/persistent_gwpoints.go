...
type PersistentGwpointsApplication struct {
	app *GwpointsApplication
	db  dbm.DB
...
func NewPersistentGwpointsApplication(dbDir string) *PersistentGwpointsApplication {
	db := dbm.NewDB("gwpoints", "leveldb", dbDir)
	...
	return &PersistentGwpointsApplication{
		app:    &GwpointsApplication{state: stateTree},
		db:     db,
		logger: log.NewNopLogger(),
	}
}

func (app *PersistentGwpointsApplication) SetLogger(l log.Logger) {
	app.logger = l
}

func (app *PersistentGwpointsApplication) Info() (resInfo types.ResponseInfo) {
...
func (app *PersistentGwpointsApplication) SetOption(key string, value string) (log string) {
	return app.app.SetOption(key, value)
}

// tx is either "key=value" or just arbitrary bytes
func (app *PersistentGwpointsApplication) DeliverTx(tx []byte) types.Result {
...
func (app *PersistentGwpointsApplication) CheckTx(tx []byte) types.Result {
	return app.app.CheckTx(tx)
}

func (app *PersistentGwpointsApplication) Commit() types.Result {
	// Save
...
func (app *PersistentGwpointsApplication) Query(reqQuery types.RequestQuery) types.ResponseQuery {
	return app.app.Query(reqQuery)
}

// Save the validators in the merkle tree
func (app *PersistentGwpointsApplication) InitChain(validators []*types.Validator) {
...
func (app *PersistentGwpointsApplication) BeginBlock(hash []byte, header *types.Header) {
...
func (app *PersistentGwpointsApplication) EndBlock(height uint64) (resEndBlock types.ResponseEndBlock) {
...
func (app *PersistentGwpointsApplication) Validators() (validators []*types.Validator) {
...
func (app *PersistentGwpointsApplication) execValidatorTx(tx []byte) types.Result {
...
func (app *PersistentGwpointsApplication) updateValidator(v *types.Validator) types.Result {
