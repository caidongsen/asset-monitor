...
import (
	...
	"github.com/tendermint/tendermint/apps/gfcollection"
...
func genImportCaseList(t *testing.T) string {
	req := &gfcollection.RequestImportCaseList{}
	var caselist []*gfcollection.Case
	c := &gfcollection.Case{}
	c.CaseId = "1231231"
	c.CaseOwner = "1231231"
	c.CaseIdCard = "1231231"
	c.Conttact = "12312"
	c.BankCard = "1231231"
	c.DebtAmount = int64(12312313)
	c.OriginalAmount = int64(123212)
	c.Fees = int64(12312)
	c.OverdueDays = int32(123)
	c.DelayDays = int32(12)
	c.CaseArea = "bj"
	c.CaseState = CaseState_CS_UNK
	caselist = append(caselist, c)
	req.CaseList = caselist
	request := &gfcollection.Request{}
	request.Value = &gfcollection.Request_ImportCaseList{req}
	request.Uid = "684160"
	request.InstructionId = "123123123123"
	request.Pubkey, _ = hex.DecodeString("94a410c72af6144a8cb8541b52ee2dc4541a949d75db54b6183a5f1b2908ae48")
	request.ActionId = gfcollection.MessageType_MsgImportCaseList
	data2, err := gfcollection.MarshalMessage(request)
	if err != nil {
		panic(err)
	}
	priv, _ := hex.DecodeString("0bf0d7a1e8cd3c4f4940852789997c4ff980a1a2d8f47e1b8523dd19d536109b94a410c72af6144a8cb8541b52ee2dc4541a949d75db54b6183a5f1b2908ae48")
	request.Sign = gfcollection.Signdata(priv, data2)

	data2, err = gfcollection.MarshalMessage(request)
	if err != nil {
		t.Fatal(err)
	}
	data3 := base64.StdEncoding.EncodeToString(data2)
	return data3
}
