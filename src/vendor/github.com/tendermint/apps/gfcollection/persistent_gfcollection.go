...
type PersistentGfcollectionApplication struct {
	app *GfcollectionApplication
	db  dbm.DB
...
func NewPersistentGfcollectionApplication(dbDir string) *PersistentGfcollectionApplication {
	db := dbm.NewDB("gfcollection", "leveldb", dbDir)
	...
	return &PersistentGfcollectionApplication{
		app:    &GfcollectionApplication{state: stateTree},
		db:     db,
		logger: log.NewNopLogger(),
	}
}

func (app *PersistentGfcollectionApplication) SetLogger(l log.Logger) {
	app.logger = l
}

func (app *PersistentGfcollectionApplication) Info() (resInfo types.ResponseInfo) {
...
func (app *PersistentGfcollectionApplication) SetOption(key string, value string) (log string) {
	return app.app.SetOption(key, value)
}

// tx is either "key=value" or just arbitrary bytes
func (app *PersistentGfcollectionApplication) DeliverTx(tx []byte) types.Result {
...
func (app *PersistentGfcollectionApplication) CheckTx(tx []byte) types.Result {
	if isValidatorTx(tx) {
		return types.OK
	}
...
func (app *PersistentGfcollectionApplication) Commit() types.Result {
	// Save
...
func (app *PersistentGfcollectionApplication) Query(reqQuery types.RequestQuery) types.ResponseQuery {
	return app.app.Query(reqQuery)
}

// Save the validators in the merkle tree
func (app *PersistentGfcollectionApplication) InitChain(validators []*types.Validator) {
...
func (app *PersistentGfcollectionApplication) BeginBlock(hash []byte, header *types.Header) {
...
func (app *PersistentGfcollectionApplication) EndBlock(height uint64) (resEndBlock types.ResponseEndBlock) {
...
func (app *PersistentGfcollectionApplication) Validators() (validators []*types.Validator) {
...
func (app *PersistentGfcollectionApplication) execValidatorTx(tx []byte) types.Result {
...
func (app *PersistentGfcollectionApplication) updateValidator(v *types.Validator) types.Result {
