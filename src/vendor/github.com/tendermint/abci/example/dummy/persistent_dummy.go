...
func (app *PersistentDummyApplication) Commit() types.Result {
	...
	app.logger.Info("Saved state", "root", hex.EncodeToString(appHash))
	...
	app.logger.Info("Saving block", "height", lastBlock.Height, "root", hex.EncodeToString(lastBlock.AppHash))
